    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            CREATE TABLE `ADDRESS_DETAILS` (
              `AddressDetailsKey` bigint(20) NOT NULL AUTO_INCREMENT,
              ...
              `Street_1` varchar(500) DEFAULT NULL,
              `Street_2` varchar(110) DEFAULT NULL,
              `Street_3` varchar(110) DEFAULT NULL,
              ...
              `IEC_Number` varchar(50) DEFAULT NULL,
              `Tax_ID` varchar(50) DEFAULT NULL,
              `Vat_IOSS_Number` varchar(50) DEFAULT NULL,
              `CreateTs` timestamp NOT NULL DEFAULT current_timestamp(),
              `CreatedBy` varchar(50) DEFAULT NULL,
              `ModifyTs` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
              `ModifiedBy` varchar(50) DEFAULT NULL,
              PRIMARY KEY (`AddressDetailsKey`),
              KEY `idx_comb` (`Tracking_Number`,`Address_Type`),
