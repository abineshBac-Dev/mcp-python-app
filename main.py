    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            CREATE TABLE `CONSIGNMENT_HISTORY` (
              `ConsignmentHistoryKey` bigint(20) NOT NULL AUTO_INCREMENT,
              `Tracking_Number` varchar(50) NOT NULL,
              `Status_Code` varchar(25) DEFAULT NULL,
              `StatusTs` datetime DEFAULT NULL,
              `Current_Hub_Code` varchar(25) DEFAULT NULL,
              `Current_Hub_Name` varchar(50) DEFAULT NULL,
              `Current_Location` varchar(100) DEFAULT NULL,
              `Current_Location_Code` varchar(20) DEFAULT NULL,
              `Current_Location_Office_Type` varchar(20) DEFAULT NULL,
              `Next_Destination_Hub_Code` varchar(25) DEFAULT NULL,
              `Next_Destination_Hub_Name` varchar(50) DEFAULT NULL,
              `Next_Destination_Location` varchar(100) DEFAULT NULL,
              `Next_Destination_Location_Code` varchar(20) DEFAULT NULL,
              `Mode` varchar(50) DEFAULT NULL,
              `Milestone` varchar(50) DEFAULT NULL,
              `Remarks` varchar(1000) DEFAULT NULL,
              `Key_Reference_No` varchar(50) DEFAULT NULL,
              ...
              `Biker_code` varchar(25) DEFAULT NULL,
              `Driver_Number` varchar(25) DEFAULT NULL,
              `Driver_Name` varchar(100) DEFAULT NULL,
              `CreateTs` timestamp NOT NULL DEFAULT current_timestamp(),
              `CreatedBy` varchar(50) DEFAULT NULL,
              `ModifyTs` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
              `ModifiedBy` varchar(50) DEFAULT NULL,
              PRIMARY KEY (`ConsignmentHistoryKey`),
              KEY `idx_comb` (`Tracking_Number`,`ConsignmentHistoryKey`),
              KEY `idx_CreateTs` (`CreateTs`),
              KEY `idx_Status_Code` (`Status_Code`,`StatusTs`),
              KEY `idx_history` (`Tracking_Number`,`StatusTs`,`Status_Code`)
            )
            """)
        conn.commit()
        conn.close()
